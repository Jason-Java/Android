...
public class JasonTextView extends View {
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        try {
            //默认背景
            Drawable drawable = attr.getDrawable(R.styleable.JasonButton_ja_bgColorDefault);
            ...
            //按压背景
            drawable = attr.getDrawable(R.styleable.JasonButton_ja_bgColorPress);
            if (drawable instanceof ColorDrawable) {
            ...
            drawable = attr.getDrawable(R.styleable.JasonButton_ja_bgColor);
            if (drawable instanceof ColorDrawable) {
    ...
    private void drawText(Canvas canvas) {
        ...
        switch (gravity) {
            //center
            case 0X01:
                canvas.drawText(text, (paddingLeft + width - textWidth - paddingRight) / 2.0f, (paddingTop + height - fontMetrics.bottom - fontMetrics.top - paddingBottom) / 2.0f, paint);
                break;
            //center_vertical
            case 0X02:
                canvas.drawText(text, paddingLeft - paddingRight,  (paddingTop +height - fontMetrics.descent - fontMetrics.ascent - paddingBottom) / 2.0f, paint);
                break;
            //center_horizontal
            case 0X03:
                canvas.drawText(text,  (paddingLeft +width - textWidth- paddingRight) / 2.0f , paddingTop - fontMetrics.ascent - paddingBottom, paint);
                break;
        }
    }
