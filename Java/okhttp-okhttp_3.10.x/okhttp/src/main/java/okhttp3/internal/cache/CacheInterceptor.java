...
public final class CacheInterceptor implements Interceptor {
  ...
  @Override public Response intercept(Chain chain) throws IOException {
    ...
    Request networkRequest = strategy.networkRequest; // TODO 网络请求
    Response cacheResponse = strategy.cacheResponse;  // TODO 响应缓存
    ...
    if (cacheResponse != null) {
      // TODO 我们有缓存 并且服务器响应码 304(数据为修改) 则我们返回缓存数据
    ...
    // TODO 如果我么配置了缓存 并根据缓存策略决定是否将 服务器相应的数据写入缓存
    if (cache != null) {
